...
function [best_M, best_bic, all_Ms] = wrapper_for_brute_force_phylo_with_pre_clust_auto_size(F_reduced, error_rate, min_tree_size, max_tree_size, path_to_folder, exec_name, cpu_gpu, cost, k_best, gpu_id, cpu_cores, num_devices, tree_subset, CUDA_thread_block, CUDA_blocks )
    ...
    for tree_size = min_tree_size:max_tree_size
        ...
        [M_tmp, run_time] = count_wrapper_GPU_bowie_ll(clustered_Fs, path_to_folder, exec_name, cpu_gpu, cost, k_best, gpu_id, cpu_cores, num_devices, tree_subset, CUDA_thread_block, CUDA_blocks );
