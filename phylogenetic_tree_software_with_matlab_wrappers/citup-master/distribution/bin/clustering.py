...
argparser.add_argument('-cf', help='Cluster file location (Cluster members go to this file)')
argparser.add_argument('-f_hat', help='f_hat file location (ILP F values go to this file)')
...
cluster_file_location = arguments.cf
f_hat_file_location = arguments.f_hat
...
output_cluster = open(cluster_file_location, 'w')
output_f_hat = open(f_hat_file_location, 'w')
...
for cluster in cluster_centers:
    for s in cluster:
        ...
        output_f_hat.write('{:10.5f}'.format(s) + ' ')
    output.write("\n")
    output_f_hat.write("\n")
...
for s in labels:
    ...
    output_cluster.write('{:6}'.format(s) + ' ')
